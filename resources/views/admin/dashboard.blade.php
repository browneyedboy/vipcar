...
@section('dashboard')
    ...
    <script src="{{ url('admin') }}/js/plugins/flot/curvedLines.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="{{ url('admin') }}/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    ...
    <!-- ChartJS-->
    <script src="{{ url('admin') }}/js/plugins/chartJs/Chart.min.js"></script>
